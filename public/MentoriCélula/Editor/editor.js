...
// -----------------------------
// Cursor fixes (hover-specific eraser)
// -----------------------------
function applyRemovableHover(imgs, isRemoveMode) {
    imgs.forEach(img => {
        if (isRemoveMode) {
...
if (popupimageremove) {
    popupimageremove.addEventListener("click", (ev) => {
        ...
        applyRemovableHover(imgs, popupimageremovemode);

        popupimageremove.textContent = popupimageremovemode ? "Cancelar quitar" : "Quitar imagen";
    });
}

// Update main remove toggle
if (mainremoveBtn) {
    mainremoveBtn.addEventListener("click", (ev) => {
        ev.stopPropagation();
        mainimageremoveMode = !mainimageremoveMode;
        ...
        applyRemovableHover(imgs, mainimageremoveMode);
