...
function exitRemoveModes() {
    ...
    document.querySelectorAll(".main-image, .pop-up-image").forEach(img => {
...
if (popupimageremove) {
    popupimageremove.addEventListener("click", () => {
        ...
        popupimagecontainer.querySelectorAll("img").forEach(img => {
            img.classList.toggle("removable", popupimageremoveMode);
            img.onclick = () => {
                if (popupimageremoveMode) img.remove();
            };
        });
    });
}
...
if (mainremoveBtn) {
    mainremoveBtn.addEventListener("click", () => {
        ...
        mainimagesContainer.querySelectorAll("img").forEach(img => {
            img.classList.toggle("removable", mainimageremoveMode);
            img.onclick = () => {
                if (mainimageremoveMode) img.remove();
            };
        });
    });
}

// Cancel remove mode by clicking outside images/buttons
